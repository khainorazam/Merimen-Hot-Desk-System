...
<cfset DS=StructNew()>
<cfset APPINST='EPL-DEV'>
<!--- <cfset CURDSN="merimen_ic21"> --->
<cfset CURDSN="intro"> 
...
<!--- <cfset Application.MICDSN = "merimenic_21">
<cfset Application.PARTDSN = "mparts_db">
 --->
<cfset application.MICDSN ="">
<cfset request.MTRDSN=Application.MTRDSN>
<cfset request.SVCDSN=Application.SVCDSN>
<cfset request.MICDSN = Application.MICDSN>
<cfset Application.ApplicationName= 'EPL'>
...
<cfset DS.CO=structNew()>
<cfset DS.FDOC_DOCDEFS=structNew()>
